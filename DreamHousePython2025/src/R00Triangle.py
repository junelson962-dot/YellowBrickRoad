...
class R00Triangle(Shape):
    def __init__(self, canvas: Canvas, x: int = 50, y: int = 15, height: int = 40, width: int = 70, color: str = "blue", fill: str = None, line: int = 2):
    ...
    def draw(self):
        if self.is_visible:
            ...
            self.shape_id = self.canvas.create_polygon(
                self.x_position + 50, self.y_position ,
